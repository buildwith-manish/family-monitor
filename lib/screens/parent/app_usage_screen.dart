        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Padding(
              ...
              child: Text('Tap a cell to see exact minutes',
                  style: GoogleFonts.inter(
                      fontSize: 11, color: Colors.grey.shade500)),
            ),
            HourlyHeatmapWidget(childUid: widget.childUid),
            const SizedBox(height: 8),
          ]),
        ),
      ]),
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Padding(
            ...
            child: Row(children: [
              const Icon(Icons.donut_large_outlined,
                  color: Color(0xFF9334E6), size: 18),
              const SizedBox(width: 8),
          ...
          Padding(
            ...
            child: Text('Tap a segment to highlight · Today\'s data',
                style: GoogleFonts.inter(
                    fontSize: 11, color: Colors.grey.shade500)),
          ),
          CategoryBreakdownWidget(apps: _apps),
          const SizedBox(height: 8),
        ]),
      ),
    );
